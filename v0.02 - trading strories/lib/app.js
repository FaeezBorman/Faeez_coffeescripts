...
(function() {
  var Config, Functions, indicator, limits, sellTrade, story;

  sellTrade = (function() {

    function sellTrade(tn, p, v, tf, tsl, tp, sl, tpv, slv) {
      this.tn = tn;
      this.p = p;
      this.v = v;
      this.tf = tf;
  ...
  limits = (function() {
    ...
    function limits(asset_have, lvl1_tc, lvl1_max, lvl2_tc, lvl2_max) {
      this.asset_have = asset_have;
      this.lvl1_tc = lvl1_tc;
      this.lvl1_max = lvl1_max;
      this.lvl2_tc = lvl2_tc;
      this.lvl2_max = lvl2_max;
    }

    limits.prototype.set_levels = function(asset) {
      this.asset = asset;
      this.lvl1_max = this.asset / 5;
      this.lvl2_max = this.asset / 5;
      this.lvl1_tc = 0;
      return this.lvl2_tc = 0;
    };

    limits.prototype.get_asset_lvl1 = function() {
      if ((this.lvl1_tc * 0.1) <= this.lvl1_max) {
    ...
    limits.prototype.get_asset_lvl2 = function() {
  ...
  ({
    ...
    handle: function(context, data) {
      var H, L, ave_price, btc_have, fiat_have, hlmode, hlrange, i, ihigh, ilow, inprofit, instrument, l, max, min, open_trade, psar, sar, tcount, total_price, trend, x, _i, _results;
      ...
      for (i in context.trade) {
        ...
        if (context.downfromlast && inprofit) {
      ...
      if (open_trade && context.limits.get_asset_lvl1() > 0) {
        ...
        if (hlrange.in_price > 20) {
          ...
          for (x = _i = 1; _i <= 3; x = ++_i) {
            _results.push(context.trade.push(new sellTrade(context.tradeNo, context.price, context.vol / 3, context.tf, x + 2)));
          }
          return _results;
        }
      }
